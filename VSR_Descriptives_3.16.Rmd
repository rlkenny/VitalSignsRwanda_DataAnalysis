...
ggsave("A_crops_grown.png", plot = A_crops_grown, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
ggsave("A_food_loss.png", plot = A_food_loss, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
  width = 3.5, height = 4.5, units = c("in"),
  dpi = 300)

```

###Soil quality bby landscape
```{r}
...
ggsave("A_soil_quality.png", plot = A_soil_quality, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
ggsave("A_reason_inter.png", plot = A_reason_inter, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
A_crop_inorg_fert <- ggplot(data=joined_df, aes(x=ag3a_07_1, y=ag3a_47, fill=ag3a_46))+
...
ggsave("A_crop_inorg_fert.png", plot = A_crop_inorg_fert, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
ggsave("A_landscape_inorg_fert.png", plot = A_landscape_inorg_fert, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
A_crop_org_fert <- ggplot(data=joined_df, aes(x=ag3a_07_1, y=ag3a_40, fill=ag3a_39a))+
  geom_bar(stat="identity")+
  xlab("Crop type")+
...
ggsave("A_crop_org_fert.png", plot = A_crop_org_fert, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
ggsave("A_landscape_org_fert.png", plot = A_landscape_org_fert, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
A_crop_pest <- ggplot(data=joined_df, aes(x=ag3a_07_1, y=ag3a_60_1, fill=ag3a_59))+
  geom_bar(stat="identity")+
  xlab("Crop type")+
...
ggsave("A_crop_pest.png", plot = A_crop_pest, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
...
ggsave("A_landscape_pest.png", plot = A_landscape_pest, device = "png", path = "~/Documents/Bren/GP/3Graphs/Appendix/",
  width = 4.5, height = 3.5, units = c("in"),
  dpi = 300)
