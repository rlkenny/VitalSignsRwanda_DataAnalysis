...
```{r}
#Just confirming this whole process resulted in more data points (more households) than the old csv 
...
Ag practices indicators for reference:
...
```{r}
##Creating data frames for variables of interest, and then for each practice, giving a binary assingment for whether households ever used each practice
