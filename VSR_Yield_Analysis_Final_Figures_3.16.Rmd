...
group_by(crop_name) %>% filter(n() >= 30) %>%  droplevels() %>% 
  select("kg_perha_planted", "crop_name", "ag4a_04", "ag3a_14", "ag4a_19", "hh_e65_1", "org_perha_planted", "inorg_perha_planted", "pest_perha_planted", "landscape_no", "round", "season", "cluster")
...
### Don't include this figure, just looking at missingness

library(naniar)
#k <- miss_var_summary(n30)
...
```{r}
#making sure everything is factors that need to be
...
```{r}
#running a cluster regression for each crop which met criteria above, for each intervention. Recal data has already been trimmed of top and bottom 2.5% of yield observations for each crop.
...
###Done with linear models KG, simple linear model COEF plots below
...
inter_coefs$term
inter_coefs$term[which(inter_coefs$term=="intercroppedTRUE")] <- "" #this annoying line of code gets rid of x axis lable on plot
...
# ordered_crop <- c("Banana Beer", "Beans", "Cassava", "Irish Potatoes", "Maize", "Sorghum", "Soyabeans")
# inter_coefs <- inter_coefs %>% 
#     mutate(crop_name =  factor(crop_name, levels = ordered_crop)) %>%
#     group_by(model) %>% arrange(crop_name) 
#   
lm_plot_inter <- 
dwplot(inter_coefs, dodge_size =  .7)+
  geom_vline(xintercept = 0, linetype = 'dashed', colour = "darkgrey"  )+
  ggtitle("95% Confidence Interval of Intercropping\nCoefficients Simple Linear Regression Models")+
  xlab("Harvest Volume (Kg per HA Planted)")+
  scale_color_manual(name="Crop Type", values = c("#a6cd5b", "#eb8932", "#72bad3", "#eb4024", "#e8af3c", "#449d8b", "#752559")) +
  theme_vsr()

ggsave("lm_plot_inter.png", plot = lm_plot_inter, device = "png", path = "~/Documents/",
...
```{r}
##Save pathway, (un hashtag ic_coef above)

#ggsave("inter_coefs.png", plot = ic_coef, device = "png", path = "~/Desktop/",
# scale = 1, width = 5, height = 3.5,
 #dpi = 1000)
```
...
lm_plot_org <- dwplot(ogfert_coefs, dodge_size =  .7)+
  geom_vline(xintercept = 0, linetype = 'dashed', colour = "darkgrey"  )+
  ggtitle("95% Confidence Interval of Organic Fertilizer Coefficients\nSimple Linear Regression Models")+
xlab("Harvest Volume (Kg per HA Planted)")+
  scale_color_manual(name="Crop Type", values = c("#a6cd5b", "#eb8932", "#72bad3", "#eb4024", "#e8af3c", "#449d8b", "#752559", "#2c6b96", "#9c8dc3")) +
  theme_vsr()

lm_plot_org

ggsave("lm_plot_org.png", plot = lm_plot_org, device = "png", path = "~/Documents/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
#ggsave("ogfert_coefs.png", plot = og_coefs, device = "png", path = "~/Desktop/",
# scale = 1, width = 5, height = 3.5,
 #dpi = 1000)
```
...
ggtitle("Improved Seed Coefficients:\nKGs Per HA Planted")+
  geom_vline(xintercept = 0, linetype = 'dashed', colour = "darkgrey"  )+
  ggtitle("95% Confidence Interval of Improved Seed Coefficients\nSimple Linear Regression Models")+
  xlab("Harvest Volume (Kg per HA Planted)")+
  scale_color_manual(name="Crop Type", values = c("#eb8932", "#72bad3", "#eb4024", "#e8af3c", "#a66f5b", "#449d8b", "#752559", "#2c6b96", "#9c8dc3")) +
  theme_vsr()

lm_plot_seed

ggsave("lm_plot_seed.png", plot = lm_plot_seed, device = "png", path = "~/Documents/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggtitle("Erosion Control Coefficients:\nKGs Per HA Planted")+
  geom_vline(xintercept = 0, linetype = 'dashed', colour = "darkgrey"  )+
  ggtitle("95% Confidence Interval of Erosion Control Coefficients\nSimple Linear Regression Models")+
xlab("Harvest Volume (Kg per HA Planted)")+
  scale_color_manual(name="Crop Type", values = c("#a6cd5b", "#eb8932", "#72bad3", "#eb4024", "#e8af3c", "#a66f5b", "#449d8b", "#752559", "#2c6b96", "#9c8dc3")) +
  theme_vsr()
...
ggsave("lm_plot_erosion.png", plot = lm_plot_erosion, device = "png", path = "~/Documents/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggtitle("Pesticide Coefficients:\nKGs Per HA Planted")+
  geom_vline(xintercept = 0, linetype = 'dashed', colour = "darkgrey"  )+
  ggtitle("95% Confidence Interval of Pesticide Coefficients\nSimple Linear Regression Models")+
xlab("Harvest Volume (Kg per HA Planted)")+
...
ggsave("lm_plot_pest.png", plot = lm_plot_pest, device = "png", path = "~/Documents/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggtitle("Inorg Fert Coefficients:\nKGs Per HA Planted")+
  geom_vline(xintercept = 0, linetype = 'dashed', colour = "darkgrey"  )+
  ggtitle("95% Confidence Interval of Inorganic Fertilizer Coefficients\nSimple Linear Regression Models")+
xlab("Harvest Volume (Kg per HA Planted)")+
  scale_color_manual(name="Crop Type", values = c("#eb8932", "#eb4024", "#e8af3c", "#a66f5b","#2c6b96", "#9c8dc3")) +
  theme_vsr()

lm_plot_inorg

ggsave("lm_plot_inorg.png", plot = lm_plot_inorg, device = "png", path = "~/Documents/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
####Now Multiple Regression Coef Plots
...
mlm_plot_beans <- coefplot(mod_boldc$lm_res, title = '\n\nBeans ', ylab="", xlab = "Kg per HA Planted", color = "#eb8932", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted", "pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer")) +
  theme_vsr()
...
mlm_plot_irish_potatoes <- coefplot(mod_poldc$lm_res, title = '\n\nIrish Potatoes ', ylab="", xlab = "Kg per HA Planted", color="#eb4024", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted","pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer", pest_perha_planted = "10s KGs of Pesticide"))+
  theme_vsr()
...
mlm_plot_maize <- 
coefplot(mod_moldc$lm_res, predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted"), title = '\nMaize ', ylab="", xlab = "Kg per HA Planted", color = "#e8af3c",  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer"))+
  theme_vsr()
...
mlm_plot_paddy <- 
coefplot(mod_pyold$lm_res, title = '\n\nPaddy ', ylab="", xlab = "Kg per HA Planted", color="#a66f5b", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted","pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer", pest_perha_planted = "10s KGs of Pesticide"))+
  theme_vsr()
...
mlm_plot_sorghum <- 
coefplot(mod_sold$lm_res, title = '\n\nSorghum ', ylab="", xlab = "Kg per HA Planted", color="#449d8b", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted","pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer", pest_perha_planted = "10s KGs of Pesticide"))+
  theme_vsr()
...
mlm_plot_soyabeans <- 
coefplot(mod_soyold$lm_res, title = '\n\nSoyabeans ', ylab="", xlab = "Kg per HA Planted", color="#752559", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted","pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer", pest_perha_planted = "10s KGs of Pesticide"))+
  theme_vsr()
...
mlm_plot_sweet_potatoes <- coefplot(mod_spoldc$lm_res, title = '\nSweet Potatoes ', ylab="", xlab = "Kg per HA Planted", color = "#2c6b96", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer")) +
  theme_vsr()
...
ggdraw() +
  ...
  draw_label("95% Confidence interval of Multiple Linear Regression Coefficients: Harvest Volume", x=.5, y=.97, fontfamily = "Palatino")
...
ggdraw() +
  ...
  draw_label("95% Confidence interval of Multiple Linear Regression Coefficients: Harvest Volume", x=.5, y=.99, fontfamily = "Palatino")
...
ggsave("mlm_ALL.png", plot = mlm_ALL, device = "png", path = "~/Documents/",
...
#remember this is trimmed data ( top and bottom 2.5% of KG per HA pLanted)

#mlm_top4 <- 
ggdraw() +
  draw_plot(p1oldc, x = 0, y = .5, width = .5, height = .5) +
  draw_plot(p2oldc, x = .5, y = .5, width = .5, height = .5) +
  draw_plot(p3oldc, x = 0, y = 0, width = .5, height = 0.5) +
  draw_plot(p4oldc, x = .5, y = 0, width = .5, height = 0.5) +
  draw_label("95% Confidence interval of Multiple Linear Regression Coefficients: Harvest Volume", x=.5, y=.97, fontfamily = "Palatino")

#ggsave("mlm_top4.png", plot = mlm_top4, device = "png", path = "~/Documents/",
