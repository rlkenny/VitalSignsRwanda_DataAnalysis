...
+scale_fill_manual(values = c("#e03c21", "#de6e5b", "eb8932", "#dab03a", "#e6cd4f", "#b4ce8f", "90c3ab", "55ad71", "#5498af", "#85b6c4", "#5498af") 
...
mlm_plot_sorghum <- 
coefplot(mod_sold$lm_res, title = '\n\nSorghum (n= 78)', ylab="", xlab = "Kg per HA Planted", color="#55ad71", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted","pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer", pest_perha_planted = "10s KGs of Pesticide"))+
  theme_vsr()
...
mlm_plot_soyabeans <- 
coefplot(mod_soyold$lm_res, title = '\n\nSoyabeans (n= 32)', ylab="", xlab = "Kg per HA Planted", color="#70519b", predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted","pest_perha_planted"),  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer", pest_perha_planted = "10s KGs of Pesticide"))+
  theme_vsr()
