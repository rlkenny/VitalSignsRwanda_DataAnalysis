...
#mutate(n30, improved_seed = case_when(ag4a_23 == "2" | ag4a_23 == "3" ~ 1, ag4a_23 == "1" | ag4a_23 == "NA" ~ 2))
...
ggsave("lm_plot_org.png", plot = lm_plot_org, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
...
ggsave("lm_plot_inorg.png", plot = lm_plot_inorg, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggsave("lm_plot_pest.png", plot = lm_plot_pest, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggsave("lm_plot_inter.png", plot = lm_plot_inter, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggsave("lm_plot_seed.png", plot = lm_plot_seed, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
ggsave("lm_plot_erosion.png", plot = lm_plot_erosion, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
  width = 4, height = 3.3, units = c("in"),
  dpi = 300)
...
mlm_plot_maize <- 
coefplot(mod_moldc$lm_res, predictors = c("intercropped", "erosion_c", "purchased_seed", "inorg_perha_planted", "org_perha_planted"), title = '\nMaize (n=348)', ylab="", xlab = "Kg per HA Planted", color = "#e8af3c",  sort="alphabetical", newNames=c(erosion_cTRUE="Erosion Control", intercroppedTRUE = "Intercropped", purchased_seedTRUE = "Purchased Seed", inorg_perha_planted ="10s KGs of Inorganic Fertilizer", org_perha_planted = "100s KGs of Organic Fertilizer"))+
  theme_vsr()
...
ggsave("mlm_ALL.png", plot = mlm_ALL, device = "png", path = "~/Documents/Bren/GP/3Graphs/Results/",
